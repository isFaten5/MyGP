...
class Reassign extends StatelessWidget {
  Reassign({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: -278.0, end: 34.0),
            Pin(size: 139.0, middle: 0.2273),
            child: Stack(
              children: <Widget>[
                Stack(
                  children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 303.0, end: -16.0),
            Pin(size: 21.0, middle: 0.2744),
            child: Text(
              'أختار ولي أمر ليتم تعيينه لطالب',
              style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 16,
                color: const Color(0xff27b7a9),
                letterSpacing: -0.291735107421875,
                fontWeight: FontWeight.w500,
                height: 1.375,
              ),
              textHeightBehavior:
