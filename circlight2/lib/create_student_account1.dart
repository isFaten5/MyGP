...
class CreateStudentAccount1 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 174.0, end: 13.5),
            Pin(size: 24.0, start: 44.0),
            child:
                // Adobe XD layer: 'إنشاء حساب الطالب' (text)
                Text(
              'إنشاء حساب الطالب',
              style: TextStyle(
                fontFamily: 'Inter',
          ...
          Pinned.fromPins(
            Pin(size: 293.0, end: 13.0),
            Pin(size: 1.0, start: 80.0),
            child:
          ...
          Pinned.fromPins(
            Pin(start: 33.0, end: 22.3),
            Pin(size: 589.0, start: 81.0),
            child:
                // Adobe XD layer: 'Frame 1074' (group)
                Stack(
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.fromLTRB(0.0, 0.0, 0.0, 57.0),
                  child:
                            ...
                            children: <Widget>[
                              Pinned.fromPins(
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromPins(
                                      Pin(size: 143.0, end: 6.9),
                                      Pin(size: 24.0, start: 0.0),
                                      child:
                                          // Adobe XD layer: 'اسم طالب' (text)
                                          Text(
                                        'اسم طالب',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                    ...
                                    Pinned.fromPins(
                                      Pin(size: 122.0, end: 3.0),
                                      Pin(size: 20.0, middle: 0.6042),
                                      child:
                                          // Adobe XD layer: 'أدخل اسم الطالب' (text)
                                          Text(
                                        'أدخل اسم الطالب  ',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromPins(
                                      ...
                                      Pin(size: 24.0, start: 0.0),
                                      child:
                                          // Adobe XD layer: 'اسم المستخدم' (text)
                                          Text(
                                        'اسم المستخدم',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                    ...
                                    Align(
                                      alignment: Alignment(1.0, 0.559),
                                      child: SizedBox(
                                        width: 143.0,
                                        height: 20.0,
                                        child:
                                            // Adobe XD layer: 'أدخل أسم المستخدم' (text)
                                            Text(
                                          'أدخل أسم المستخدم',
                                          style: TextStyle(
                                            fontFamily: 'Inter',
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromPins(
                                      ...
                                      Pin(size: 24.0, start: 0.0),
                                      child:
                                          // Adobe XD layer: 'اسم ولي الامر' (text)
                                          Text(
                                        'اسم ولي الامر',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                    ...
                                    Pinned.fromPins(
                                      Pin(size: 119.0, end: 3.0),
                                      Pin(size: 24.0, end: 10.5),
                                      child:
                                          // Adobe XD layer: 'ريناد البشر' (text)
                                          Text(
                                        'ريناد البشر',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                              ...
                              Pinned.fromPins(
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    ...
                                    Pinned.fromPins(
                                      Pin(size: 164.0, end: 3.0),
                                      Pin(size: 20.0, middle: 0.7449),
                                      child:
                                          // Adobe XD layer: 'أدخل رقم رقم صف الط…' (text)
                                          Text(
                                        'أدخل رقم رقم صف الطالب',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                          fontSize: 15,
                                          color: const Color(0xaba6a6a6),
                              ...
                              Pinned.fromPins(
                                ...
                                Pin(size: 69.0, middle: 0.6649),
                                child:
                                    // Adobe XD layer: 'Group 164' (group)
                                    Stack(
                                  children: <Widget>[
                                    Pinned.fromPins(
                                      Pin(size: 143.0, end: 5.0),
                                      Pin(size: 24.0, start: 0.0),
                                      child:
                                          // Adobe XD layer: 'الجنسية' (text)
                                          Text(
                                        'الجنسية',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                    ...
                                    Pinned.fromPins(
                                      ...
                                      Pin(size: 20.0, middle: 0.7247),
                                      child:
                                          // Adobe XD layer: 'أدخل جنسية' (text)
                                          Text(
                                        'أدخل جنسية  ',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromPins(
                                      ...
                                      Pin(size: 24.0, start: 0.0),
                                      child:
                                          // Adobe XD layer: 'رقم الهوية / الإقامة' (text)
                                          Text(
                                        'رقم الهوية / الإقامة',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                    ...
                                    Pinned.fromPins(
                                      Pin(size: 165.0, end: 3.0),
                                      Pin(size: 20.0, middle: 0.7449),
                                      child:
                                          // Adobe XD layer: 'أدخل رقم الهوية/ ال…' (text)
                                          Text(
                              ...
                              Pinned.fromPins(
                                ...
                                child:
                                  ...
                                  children: <Widget>[
                                    Pinned.fromPins(
                                      Pin(size: 143.0, end: 6.0),
                                      Pin(size: 24.0, start: 0.0),
                                      child:
                                          // Adobe XD layer: 'فصيلة الدم' (text)
                                          Text(
                                        'فصيلة الدم',
                                        style: TextStyle(
                                          fontFamily: 'Inter',
                                    ...
                                    Align(
                                      ...
                                      child: SizedBox(
                                        ...
                                        height: 20.0,
                                        child:
                                            // Adobe XD layer: 'أدخل فصيلة الدم' (text)
                                            Text(
                                          'أدخل فصيلة الدم  ',
                                          style: TextStyle(
                                            fontFamily: 'Inter',
                      ...
                      children: <Widget>[
                        Stack(
                          children: <Widget>[
                            ...
                            Align(
                              alignment: Alignment(0.021, -0.143),
                              child: SizedBox(
                                width: 42.0,
                                height: 22.0,
                                child: Text(
...
const String _svg_rvegb4 =
    '<svg viewBox="69.0 80.0 293.0 1.0" ><path transform="matrix(1.0, -0.000002, 0.000002, 1.0, 69.0, 80.0)" d="M 0 0 L 293.0000305175781 0" fill="none" stroke="#eae8e8" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_pum8a3 =
    '<svg viewBox="32.0 68.0 6.0 12.0" ><path transform="translate(32.0, 68.0)" d="M 6 12 L 0 6 L 6 0" fill="none" stroke="#d2d2ce" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
